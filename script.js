document.addEventListener('DOMContentLoaded', () => {
    ...
    const setDropdownFromISO = (isoString) => {
        ...
        if (isNaN(date)) { setDropdownToNow(); return; }
    ...
    const initDB = () => {
        ...
        request.onerror = (e) => {
            ...
            showAlert("Error", "Gagal mengakses penyimpanan IndexedDB.");
        };
    };
    ...
    window.confirmDelete = (id) => {
        showConfirm(
            "Hapus Kenangan?", 
            "Apakah kamu yakin ingin menghapus cerita ini? Data tidak bisa dikembalikan.",
            () => deleteDataFromDB(id)
        );
    };
